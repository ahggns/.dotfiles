# Generated by Powerlevel10k configuration wizard on 2024-04-18 at 00:55 EDT.
...
() {
  ...
  # Branch icon. 
  # Set this parameter to '\uE0A0 ' for the popular Powerline branch icon.
  # Set this parameter to '\uF126 ' for the popular Font Awesome branch icon.
